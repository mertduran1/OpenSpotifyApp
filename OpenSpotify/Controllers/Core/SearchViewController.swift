...
//                            print(self?.categories)
    ...
    override func viewDidLayoutSubviews() { //olusturdugumuz kodla iliski bütün seylerin birleştirildiği yer.
...
//bana rest apiden bir data geliyorsa bu dataya karşılk allcategoriesresponse struct ı icinde bir düzen kuruyorz
