...
import Foundation
final class APICaller {   //final diyince bu classtan bir türetme yapılmaz
    //singleton
    ...
    public func getCategories(completion: @escaping(Result<[Category], Error>) -> Void) //escaping arka plandaki rest api ile haberlesirken bloklanmaması icin
    {
        createRequest(
